...
session_start();
        ...
        $sql = "SELECT prod_id prod_cost, prod_name, prod_image FROM products";
			...
			<div class="small-container">
				...
				<div class="row"> 
					...
					<div class="col-1" onclick="location.href='item.php';" style="cursor: pointer;">
						...
						<p>$<?php echo $row[8]['prod_cost']; ?> &nbsp;  </p>
					</div>
					<div class="col-1" onclick="location.href='item.php';" style="cursor: pointer;">
						<?php echo '<img src="data:image;base64,'.base64_encode($row[7]['prod_image']).'" >';?> 
						<h4><?php echo $row[7]['prod_name']; ?></h4>
						<p>$<?php echo $row[7]['prod_cost']; ?> &nbsp;  </p>
					</div>
					<div class="col-1" onclick="location.href='item.php';" style="cursor: pointer;">
						<?php echo '<img src="data:image;base64,'.base64_encode($row[0]['prod_image']).'" >';?> 
						<h4><?php echo $row[0]['prod_name']; ?></h4>
						<p>$<?php echo $row[0]['prod_cost']; ?> &nbsp; </p>
					</div>
